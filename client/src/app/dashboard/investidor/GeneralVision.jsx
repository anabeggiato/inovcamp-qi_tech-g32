    ...
    return (
        <div className='w-full space-y-8'>
            ...
            <section className='w-full p-8 border border-border rounded-lg mb-32'>
                ...
                {investimentos.map((estudante, idx) => (
                    <div key={idx} className='flex items-center justify-between w-full p-4 border border-border rounded-2xl my-4 hover:bg-gray-100'>
