...
export default function Hero() {
    return (
        <div className='flex flex-col items-center space-y-8 mt-20 text-center p-8'>
            ...
            <p className='w-[40%] text-2xl text-gray-400 font-thin'>
            ...
            <div className='flex gap-4'>
                <button className='bg-brand-gradient flex items-center gap-4 px-4 py-2 text-white rounded-lg'>Sou Estudante <ArrowRight /></button>
